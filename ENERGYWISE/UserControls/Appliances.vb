...
Public Class Appliances
    ...
    Public Shared appliancesList() As String = {
    ...
    Public Shared powerRatings() As Integer = {
    280, 1500, 750, 20, 300,
    170, 90, 380, 727, 50, 225,
    175, 12, 450, 1200, 550,
    1600, 400, 320
}
    ...
    Public Function CreateNewLabel1(PanelBox As Panel, textBox As Guna2TextBox) As Label
        ...
        For Each appliance As String In appliancesList
    ...
    Private Sub textbox1_KeyDown(sender As Object, e As KeyEventArgs) Handles textbox1.KeyDown
        If e.KeyCode = Keys.Enter Then
            CreateNewLabel1(Panel1, textbox1)
            textbox1.Text = ""
            Guna2Button1.Enabled = (labelList1.Count < 9)
        End If
    End Sub
    ...
    Private Sub textbox2_KeyDown(sender As Object, e As KeyEventArgs) Handles textbox2.KeyDown
        If e.KeyCode = Keys.Enter Then
            CreateNewLabel2(Panel2, textbox2)
            textbox2.Text = ""
            Guna2Button2.Enabled = (labelList2.Count < 9)
        End If
    End Sub
    ...
    Private Sub textbox3_KeyDown(sender As Object, e As KeyEventArgs) Handles textbox3.KeyDown
        If e.KeyCode = Keys.Enter Then
            CreateNewLabel3(Panel3, textbox3)
            textbox3.Text = ""
            Guna2Button3.Enabled = (labelList3.Count < 9)
        End If
    End Sub
